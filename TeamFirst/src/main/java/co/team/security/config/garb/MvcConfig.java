...
//
//@Configuration
//@EnableWebMvc //어노테이션 기반의 스프링 MVC를 구성할 때 필요한 Bean들을 자동으로 구성해주는 역할을 수행
//@ComponentScan(basePackages = { "co.team.security.controller" })
//public class MvcConfig implements WebMvcConfigurer {
//
//	// default servlet 핸들러를 설정한다.
//	// 원래 서블릿은 / (모든 요청)을 처리하는 default servlet을 제공한다. 스프링에서 설정한 path는 스프링이 처리하고,
//	// 스프링이 처리하지 못한 경로에 대한 처리는
