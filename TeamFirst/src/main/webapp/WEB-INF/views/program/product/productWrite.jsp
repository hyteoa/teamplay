		  ...
		  <div align="center">	
			<div class="form-group">
				<select name="category" style="width: 180px">
					...
					<option value="개인강습">개인강습</option>
					<option value="단체강습">단체강습</option>
				</select>&nbsp;&nbsp; <select name="course_title" style="width: 180px">
				...
				</select><br> <br> <select name="course_day" style="width: 90px">
				...
				<th>시</th>&nbsp;&nbsp; <select name="course_day" style="width: 90px">
				...
				</select><br> <br> <label for="title">강습시작일</label>&nbsp; <input
					type="date" name="start_date"><br> <br> <label
					for=" ">수강체크</label>&nbsp; 
